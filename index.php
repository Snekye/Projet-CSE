...
<html lang="fr">
    ...
    <body>
                ...
                <div class="info">
                    ...
                    <div class="info_acces_rapide">
                        ...
                        <div class="info_acces_rapide_premier">
                            ...
                            <a href="#partenaire" class="info_texte">Partenaire</a>
                        </div>
        ...
        <section class="home">
            ...
            <div class="bouton_offre">
                <a class="info_offre" href="Billeterie/billetterie.php">Découvrir toutes nos offres </a>
                <i class="uil uil-angle-right offre_icon"></i>
            </div>
